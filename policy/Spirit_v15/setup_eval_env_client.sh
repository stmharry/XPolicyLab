...
SPIRIT_SITECUSTOMIZE_DIR="${SCRIPT_DIR}/deploy"
...
SPIRIT_CLIENT_ENV=(
    "PYTHONPATH=${SPIRIT_SITECUSTOMIZE_DIR}:${ROOT_DIR}:${PYTHONPATH:-}"
    "SPIRIT_MODEL_CLIENT_TIMEOUT=${SPIRIT_MODEL_CLIENT_TIMEOUT:-600}"
