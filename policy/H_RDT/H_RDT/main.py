...
def parse_args(input_args=None):
    parser = argparse.ArgumentParser(description="Main script for training H-RDT.")
    parser.add_argument(
        "--config_path",
        type=str,
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "This can be a model id, a directory saved by HRDTRunner.save_pretrained, "
            "a model checkpoint path, or None when initializing from config_path."
        )
    )
    parser.add_argument(
    ...
    parser.add_argument('--upsample_rate',
        ...
        default=1,
        required=False,
        help="The upsample rate for the dataset."
    )

    parser.add_argument('--image_corrupt_severity',
        type=int,
        default=1,
        required=False,
        help="The severity of the image corruption for the model."
    )
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="The name or path of the pretrained vision encoder to use."
    )
    ...
    parser.add_argument(
        ...
        default="lang",
        choices=["lang"],
        help="Training mode: 'lang' for image+language cross-attention."
    )
    ...
    parser.add_argument(
        ...
        help="Training mode: 'pretrain' for training from scratch or continuing pretraining, 'finetune' for fine-tuning a pretrained model on new robot embodiment."
    )
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Path to pretrained backbone checkpoint for finetune mode. Action encoder and decoder will be reinitialized."
    )
